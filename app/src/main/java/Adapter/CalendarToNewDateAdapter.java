...
public class CalendarToNewDateAdapter implements NewDateInterface {
    ...
    public CalendarToNewDateAdapter(){ this.calendar = Calendar.getInstance(); }
    @Override
    public void setDay(int day) { calendar.set(Calendar.DAY_OF_MONTH, day); }

    @Override
    public void setMonth(int month) { calendar.set(Calendar.MONTH, month - 1); }
    ...
    @Override
    public void advanceDays(int days) { calendar.add(Calendar.DAY_OF_MONTH, days); }
